...
const Checkout = () => {
 ...
 const [novalue, setnovalue] = useState(true)
  ...
  return (
    <div>
    <div className="px-14 sm:px-[20px] pt-[200px] sm:pt-[300px]  relative">
      <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="relative mt-[40px] justify-between border-divider border-[1px] px-[10px] py-[10px] h-[160px]   sm:h-[150px]">
          ...
          <button className="bg-blue text-white mt-[20px] px-[10px]" style={{display:isSubmit? "none":"block"}} onClick={handleSubmit }>Click here</button>
