...
const Updates = () => {
  ...
  const EditableCard = ({ item, type, onUpdate, onDelete }) => {
    ...
    return (
      <div className="bg-[#0A1533] p-4 sm:p-5 rounded-lg mb-4 shadow hover:shadow-lg transition flex flex-col space-y-2">
        ...
        <input
          ...
          className="w-full p-2 sm:p-3 rounded bg-[#050C1F] border border-gray-700 text-gray-200"
  ...
  return (
    <div className="min-h-screen bg-[#050C1F] text-white px-4 sm:px-8 py-6 sm:py-10">
      {/* Logo + Dashboard */}
      <div className="flex flex-col sm:flex-row items-center sm:justify-between mb-10 sm:mb-12 gap-4 sm:gap-0">
        <img
          src={Logo}
          alt="Logo"
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-blue-900 rounded-lg hover:bg-blue-800 transition text-sm sm:text-lg"
        >
